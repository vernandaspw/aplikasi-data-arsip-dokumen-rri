...
class ArsipCreate extends Component
{
    ...
    public $no, $tanggal, $perihal, $No_Rak, $foto, $kantor_id, $bidang_id, $kategori_id;
    public $kantors = [], $bidangs = [], $kategoris = [];

    public function render()
    {
        $this->kategoris = KategoriArsip::latest()->get();
    ...
    public function store()
    {
        ...
        Arsip::create([
            ...
            'kategori_arsip_id' => $this->kategori_id
        ]);
